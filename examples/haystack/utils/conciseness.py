...
_example_score_3 = EvaluationExample(
    input={
        ...
        "ground_truth_answers": "Sea breezes occur due to the different heating rates of land and sea. During the day, the land warms up more quickly than the water, resulting in a pressure difference that pushes cooler air from the sea toward the land.",
    },
    score=3,
...
_example_score_2 = EvaluationExample(
    {
        "question": "What causes sea breezes?",
...
_example_score_1 = EvaluationExample(
    {
        "question": "What causes sea breezes?",
...
- Score 3:The answer is clear, direct, and to the point, with no unnecessary words, details, or repetition.""",
    ...
    model=LLMFactory(model="gpt-3.5-turbo"),
    examples=[_example_score_1, _example_score_2, _example_score_3],
)
